...
REQUIRED_STATIC_FILES = ("index.html", "app.js", "styles.css", "icons.js", "layout.js")
REQUIRED_INDEX_REFERENCES = ('href="/styles.css"', 'src="/icons.js"', 'src="/layout.js"', 'src="/app.js"')
REQUIRED_CSP_DIRECTIVES = (
    "default-src 'self'",
    "script-src 'self'",
    "style-src 'self'",
    "connect-src 'self'",
    # frame-ancestors is checked separately below (needs ALLOWED_FRAME_ANCESTOR,
    # deferred-imported from im_one_agent.web to avoid a circular import).
)
REQUIRED_STATIC_UI_SELECTORS = (
    ...
    'id="traceList"',
    'id="catalogView"',
    'id="catalogManagementSummary"',
    'id="catalogMetricManagementList"',
    'id="catalogTableManagementList"',
    'id="catalogRoleCoverageList"',
    'id="catalogIssueManagementList"',
    'id="monitorView"',
    'id="runtimeMetrics"',
    'id="auditSummaryList"',
    'id="feedbackSummaryList"',
    'id="verifiedSummary"',
    'id="catalogGovernanceSummary"',
    'id="evaluationSummary"',
    'id="readinessSummary"',
    'id="readinessActionList"',
)
...
REQUIRED_STATIC_APP_PATTERNS = (
    ...
    "data.llmModel",
    "data.promptVersion",
    "formatGenerationStatus(data)",
    "validationMetric.textContent",
    "renderTrace(data)",
    "data.executionTrace",
    "metadata?.queryPlan",
    "preExecutionRowCount",
    "showCatalog()",
    "loadCatalog()",
    "renderCatalogMetricManagement(catalogMetricManagementList",
    "renderCatalogIssueManagement(catalogIssueManagementList",
    "loadMonitoring()",
    "\"/api/metrics\"",
    "\"/api/feedback-summary\"",
    "\"/api/audit-summary\"",
    "/api/catalog?role=",
    "/api/catalog-governance?role=",
    "/api/evaluation-summary?role=",
    "\"/api/readiness\"",
    "\"/api/readiness?profile=poc\"",
    "\"/api/readiness?profile=pilot\"",
    "renderReadinessActions(readinessActionList",
    "readiness_gate?.failures",
    "live_checks_not_run",
    "poc_gate",
    "pilot_gate",
    "prd_evaluation_gate?.failures",
    "prd_evaluation_gate?.coverage_gate?.failures",
    "prd_evaluation_evidence_not_run",
    "prd_evaluation_coverage_failed",
    "poc_eval_gate",
    "pilot_eval_gate",
    "/api/verified-questions",
    "renderBacklogSummary(feedbackSummaryList, feedback.semantic_backlog",
    "calculateResultGridHeight({",
)
REQUIRED_STATIC_HTML_LAYOUT_PATTERNS = (
    ...
    'id="miniResult"',
    'id="chatInput"',
    "<summary>investment_reviews</summary>",
    "<summary>branch_targets</summary>",
    "<summary>investment_review_status</summary>",
    "<summary>new_accounts_vs_target</summary>",
)
REQUIRED_STATIC_APP_LAYOUT_PATTERNS = (
    ...
    "window.calculateResultGridHeight({",
...
PRD_TRACEABILITY_MATRIX = (
    PrdTraceabilityItem(
        "FR-001",
        "자연어 질문 입력",
        ("src/im_one_agent/web.py", "src/im_one_agent/static/app.js", "src/im_one_agent/cli.py"),
        ("tests/test_web_exports.py", "tests/test_cli.py", "tests/test_prd_alignment.py"),
        ("static_ui_assets",),
    ),
    PrdTraceabilityItem(
        "FR-002",
        "Semantic Layer",
        ("src/im_one_agent/domain.py", "src/im_one_agent/schema_retrieval.py", "src/im_one_agent/response.py"),
        ("tests/test_schema_and_generation.py", "tests/test_prd_alignment.py"),
        ("schema_retrieval_policy", "result_explanation_policy"),
    ),
    PrdTraceabilityItem(
        "FR-003",
        "Schema Retrieval",
        ("src/im_one_agent/schema_retrieval.py", "src/im_one_agent/sql_generator.py"),
        ("tests/test_schema_and_generation.py", "tests/test_prd_alignment.py"),
    ...
    PrdTraceabilityItem(
        "FR-004",
        "LLM SQL Generation",
        ("src/im_one_agent/sql_generator.py", "src/im_one_agent/graph.py"),
        ("tests/test_schema_and_generation.py", "tests/test_prd_alignment.py"),
    ...
    PrdTraceabilityItem(
        ...
        ("src/im_one_agent/sql_safety.py",),
        ("tests/test_sql_safety.py", "tests/test_prd_alignment.py"),
        ("sql_validation_policy",),
    ),
    PrdTraceabilityItem(
        "FR-006",
        "Query Execution",
        ("src/im_one_agent/graph.py", "src/im_one_agent/database_backend.py", "src/im_one_agent/sample_data.py"),
        ("tests/test_prd_alignment.py", "tests/test_web_exports.py"),
        ("database_backend", "query_timeout", "demo_query_latency", "query_plan_policy"),
    ),
    PrdTraceabilityItem(
        "FR-007",
        "Result Explanation",
        ("src/im_one_agent/response.py", "src/im_one_agent/web.py"),
        ("tests/test_prd_alignment.py", "tests/test_web_exports.py"),
    ...
    PrdTraceabilityItem(
        ...
        ("src/im_one_agent/graph.py", "src/im_one_agent/web.py", "src/im_one_agent/sample_data.py"),
        ("tests/test_prd_alignment.py", "tests/test_web_exports.py"),
    ...
    PrdTraceabilityItem(
        ...
        ("src/im_one_agent/domain.py", "src/im_one_agent/schema_retrieval.py", "src/im_one_agent/sql_safety.py"),
        ("tests/test_schema_and_generation.py", "tests/test_sql_safety.py", "tests/test_prd_alignment.py"),
        ("role_policy", "schema_retrieval_policy", "sql_validation_policy"),
    ),
    PrdTraceabilityItem(
        "FR-010",
        "Data Catalog Panel",
        ("src/im_one_agent/web.py", "src/im_one_agent/static/app.js", "src/im_one_agent/static/index.html"),
        ("tests/test_web_exports.py", "tests/test_prd_alignment.py"),
        ("static_ui_assets", "web_api_auth_policy"),
    ),
    PrdTraceabilityItem(
        "FR-011",
        "Responsive Workbench UI",
        ("src/im_one_agent/static/styles.css", "src/im_one_agent/static/app.js"),
        ("tests/test_web_exports.py", "tests/test_prd_alignment.py"),
        ("static_ui_assets",),
    ),
    PrdTraceabilityItem(
        "FR-012",
        "Evaluation Harness",
        ("src/im_one_agent/evaluation.py", "src/im_one_agent/evaluate.py"),
        ("tests/test_prd_alignment.py",),
        ("evaluation_readiness", "gold_coverage"),
    ),
    PrdTraceabilityItem(
        "NFR-SEC",
        "보안, 개인정보, 권한, 운영 통제",
        ("src/im_one_agent/intent_guard.py", "src/im_one_agent/web.py", "src/im_one_agent/sql_safety.py"),
        ("tests/test_intent_guard.py", "tests/test_web_exports.py", "tests/test_sql_safety.py"),
        ("web_api_auth_policy", "health_disclosure_policy", "synthetic_data_policy"),
    ),
    PrdTraceabilityItem(
        "NFR-DATA",
        "합성 데이터셋과 데이터 윤리",
        ("src/im_one_agent/generate_demo_data.py", "src/im_one_agent/sample_data.py"),
        ("tests/test_demo_data_generator.py", "tests/test_prd_alignment.py"),
        ("synthetic_dataset_metadata", "synthetic_data_policy"),
    ),
    PrdTraceabilityItem(
        "NFR-PERF",
        "성능과 타임아웃",
        ("src/im_one_agent/graph.py", "src/im_one_agent/preflight.py"),
        ("tests/test_prd_alignment.py",),
    ...
    PrdTraceabilityItem(
        "NFR-OBS",
        "설명 가능성과 관찰 가능성",
        ("src/im_one_agent/web.py", "src/im_one_agent/graph.py", "src/im_one_agent/evaluation.py"),
        ("tests/test_web_exports.py", "tests/test_prd_alignment.py"),
...
def check_static_ui_assets(static_dir: Path | None = None) -> PreflightCheck:
    ...
    app_js = contents["app.js"]
    icons_js = contents["icons.js"]
    styles_css = contents["styles.css"]
    ...
    for required_selector in REQUIRED_STATIC_UI_SELECTORS:
        if required_selector not in index_html:
            errors.append(f"index.html missing status selector: {required_selector}")
    for required_text in REQUIRED_STATIC_UI_TEXT:
        if required_text not in index_html and required_text not in app_js:
            errors.append(f"static UI missing required status text: {required_text}")
    for required_pattern in REQUIRED_STATIC_APP_PATTERNS:
        if required_pattern not in app_js:
            errors.append(f"app.js missing status renderer: {required_pattern}")
    ...
    for required_pattern in REQUIRED_STATIC_APP_LAYOUT_PATTERNS:
        if required_pattern not in app_js:
            errors.append(f"app.js missing PRD interaction contract: {required_pattern}")
    ...
    icon_names = sorted(set(re.findall(r'data-lucide="([^"]+)"', index_html)))
    missing_icons = [
        icon_name
        for icon_name in icon_names
        if f'"{icon_name}"' not in icons_js and f"{icon_name}:" not in icons_js
    ]
    if not icon_names:
        errors.append("index.html has no data-lucide icons to render.")
    if missing_icons:
        errors.append("icons.js missing icons: " + ", ".join(missing_icons))
    if "window.lucide" not in icons_js or "createIcons()" not in icons_js:
        errors.append("icons.js does not expose window.lucide.createIcons().")

    try:
        from im_one_agent.web import ALLOWED_FRAME_ANCESTOR, security_headers

        csp = security_headers().get("Content-Security-Policy", "")
    except Exception as exc:
        errors.append(f"security headers unavailable: {exc}")
        csp = ""
        ALLOWED_FRAME_ANCESTOR = ""

    for directive in REQUIRED_CSP_DIRECTIVES:
        if directive not in csp:
            errors.append(f"CSP missing directive: {directive}")
    if ALLOWED_FRAME_ANCESTOR and f"frame-ancestors {ALLOWED_FRAME_ANCESTOR}" not in csp:
        errors.append(f"CSP missing directive: frame-ancestors {ALLOWED_FRAME_ANCESTOR}")
    # frame-ancestors is intentionally scoped to the local test launcher origin
    # (launcher/app.py, http://127.0.0.1:7000) — strip it before the "no external
    # origins" scan below so that one whitelisted local origin doesn't trip it.
    csp_excluding_allowed_frame_ancestor = (
        csp.replace(ALLOWED_FRAME_ANCESTOR, "") if ALLOWED_FRAME_ANCESTOR else csp
    )
    for forbidden in ("https:", "http:", "unpkg.com"):
        if forbidden in csp_excluding_allowed_frame_ancestor:
    ...
    return PreflightCheck(
        ...
        True,
        (
            f"files={len(REQUIRED_STATIC_FILES)}, icons={len(icon_names)}, csp=same-origin, "
            "status=llm-validation-trace-monitoring, responsive_layout=checked"
        ),
    )
